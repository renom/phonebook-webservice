 ...
 * @OA\Schema(schema="per-page", type="integer", format="int32", minimum=0)
 * @OA\Schema(schema="from", type="integer", format="int32", minimum=0)
 * @OA\Schema(schema="to", type="integer", format="int32", minimum=0)
 * @OA\Schema(schema="total", type="integer", format="int32", minimum=0)
 * @OA\Schema(schema="url", type="string")
